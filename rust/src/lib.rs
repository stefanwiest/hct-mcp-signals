...
// Protocol types from spec (auto-generated from hct-spec/spec.yaml)
pub use spec::{DynamicsLevel, SignalType, Tempo};
...
pub use signals::{Conditions, HCTSignal, HoldType, Performance};
